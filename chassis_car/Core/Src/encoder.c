...
uint8_t encoder_data_u2[ENCODER_DATA_SIZE]={0};
uint8_t encoder_data_u3[ENCODER_DATA_SIZE]={0};
uint8_t encoder_data_u6[ENCODER_DATA_SIZE]={0};

encoder_t angle_feedback[3]={0};
